...
@Component({
  selector: 'app-asignatura-editar-admin',
  templateUrl: './asignatura-editar-admin.page.html',
  styleUrls: ['./asignatura-editar-admin.page.scss'],
})
export class AsignaturaEditarAdminPage implements OnInit {
